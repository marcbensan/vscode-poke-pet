...
class Pokemon(pygame.sprite.Sprite): 
    def __init__(self):
        ...
        # pkmn_walk2 = pygame.image.load('cyndaquil/walk2.png').convert_alpha()
        # pkmn_walk3 = pygame.image.load('cyndaquil/walk3.png').convert_alpha()
        # pkmn_walk4 = pygame.image.load('cyndaquil/walk4.png').convert_alpha()
        # pkmn_walk5 = pygame.image.load('cyndaquil/walk5.png').convert_alpha()
        # pkmn_walk6 = pygame.image.load('cyndaquil/walk6.png').convert_alpha()
